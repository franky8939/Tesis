...
\begin{figure}[!b]
\centering
\includegraphics[width=.95\textwidth]{Analisis_y_Resultados/imagenes/supersimetrias.png}
...
\begin{table}[!ht]
  \begin{center}
    \small
    \begin{tabular}{|l|ccccccccc|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		\toprule
