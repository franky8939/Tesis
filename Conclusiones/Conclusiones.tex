...
\begin{itemize_f}
\item Un generador programado en \textsfSmall{python} que automatiza la simulación del decaimiento \textbf{Dark-}\SUSY~ utilizando \textsfSmall{ Madgraph5+pythia8+Delphes3} con alta adaptabilidad a los requerimientos del usuario.
